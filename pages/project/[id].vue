    ...
    <main>
      <ContentDoc :path="`/singleprojects/${path}`" v-slot="{ doc }">
        ...
        <div class="p-4 sm:pl-0 lg:pl-20">
          ...
          <article class="mx-auto sm:mr-50 pt-0 sm:pl-50 sm:pr-50 lg:pl-80 lg:pr-80">
            <ContentRenderer :value="doc" />
          </article>
        </div>
        <div class="pt-0 mx-auto pl-4 pr-4 sm:pl-80 sm:pr-80">
          <br>
          <h2 class="font-bold mx-auto pt-0 pl-2 pr-4 sm:pl-20 sm:pr-80 pt-0">Similar Projects</h2>
